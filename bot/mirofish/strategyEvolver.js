...
const STRATEGY_GENOMES = {
  MOMENTUM: {
    ...
    params: [
      ...
      { name: 'minMomentum', type: 'int', min: 10, max: 50, default: 25, mutationRate: 0.4, mutationScale: 5 },
      ...
      { name: 'kellyFraction', type: 'float', min: 0.05, max: 0.35, default: 0.15, mutationRate: 0.2, mutationScale: 0.05 },
  ...
  PROVEN_EDGE: {
    ...
    params: [
      ...
      { name: 'minBookmakers', type: 'int', min: 1, max: 15, default: 6, mutationRate: 0.3, mutationScale: 3 },
      { name: 'kellyFraction', type: 'float', min: 0.05, max: 0.35, default: 0.25, mutationRate: 0.2, mutationScale: 0.05 },
      { name: 'maxExposure', type: 'float', min: 0.01, max: 0.05, default: 0.03, mutationRate: 0.15, mutationScale: 0.005 },
      { name: 'liquidityFilter', type: 'float', min: 500, max: 15000, default: 2000, mutationRate: 0.2, mutationScale: 1500 },
      { name: 'cooldownTicks', type: 'int', min: 1, max: 20, default: 5, mutationRate: 0.2, mutationScale: 3 },
    ],
  },
  ...
  NO_BETS: {
    ...
    params: [
      ...
      { name: 'kellyFraction', type: 'float', min: 0.05, max: 0.35, default: 0.25, mutationRate: 0.2, mutationScale: 0.05 },
      { name: 'maxExposure', type: 'float', min: 0.01, max: 0.05, default: 0.025, mutationRate: 0.15, mutationScale: 0.005 },
      { name: 'minLiquidity', type: 'int', min: 500, max: 15000, default: 2000, mutationRate: 0.2, mutationScale: 1000 },
    ],
  },
  ...
  CONTRARIAN: {
    ...
    params: [
      ...
      { name: 'kellyFraction', type: 'float', min: 0.05, max: 0.35, default: 0.20, mutationRate: 0.2, mutationScale: 0.05 },
      { name: 'maxExposure', type: 'float', min: 0.01, max: 0.05, default: 0.025, mutationRate: 0.15, mutationScale: 0.005 },
